CREATE DATABASE IF NOT EXISTS datahub DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_0900_ai_ci;
USE datahub;
...
INSERT INTO usuario (email, nome, idperfil, senha, token, criacao) VALUES ('admin@datahub.com.br', 'Administrador', 1, 'NsSzgX9AXd2G85aiCOrUwAFkiEHrHYljYWpJBCfqOvKr:WD+jsEW/Dswcivs42EZBZREfm+4WaPcZHRPG5LJpD8yr', NULL, NOW());
...
CREATE TABLE documento (
  ...
  criacao datetime NOT NULL,
  PRIMARY KEY (id),
  UNIQUE KEY documento_nome_UN (nome),
  UNIQUE KEY documento_nomecurto_UN (nomecurto)
);
